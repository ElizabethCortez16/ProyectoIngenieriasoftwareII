...
public class ControladorPersonal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String gradoInstruccion = request.getParameter("txtGradoInstruccion");
        String correo = request.getParameter("txtCorreo");
        

        
     
        Personal perso = new Personal(id, nombre, apellidopaterno, apellidomaterno, cargo, genero, telefono, direccion, fechaNacimiento, DNI, gradoInstruccion, correo);
        DAOPersonal personlbd = new DAOPersonal();
        boolean res = personlbd.insertar(perso);
