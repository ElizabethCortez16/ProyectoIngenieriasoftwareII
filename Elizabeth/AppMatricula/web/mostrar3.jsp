<%-- 
    Document   : mostrar3
    Created on : 11/11/2018, 03:02:02 PM
    Author     : JENNY
--%>
                ...
                <div class="card-body">
                    <form action="controladorrespuesta.do" method="post" >
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="txtPregun" id="txtPregun" placeholder="¿Cual es el nombre su primer conejo?" required="">
                            </div>
                        </div>                                            
